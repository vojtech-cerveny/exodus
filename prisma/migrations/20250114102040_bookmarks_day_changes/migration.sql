...
-- AlterTable
ALTER TABLE "_BrotherhoodMembers" ADD CONSTRAINT "_BrotherhoodMembers_AB_pkey" PRIMARY KEY ("A", "B");
...
-- AddForeignKey
ALTER TABLE "Versions" ADD CONSTRAINT "Versions_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
