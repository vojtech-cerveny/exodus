  ...
  return (
    <div className="prose dark:prose-invert max-w-none">
      ...
      <div className="space-y-6">
        <section>
          <Card className="p-6">
            <H3 className="mt-0 mb-6">Instalace aplikace na zařízení</H3>
        ...
        <section>
          <Card className="p-6">
            <H3 className="mt-0 mb-4">Verze textů</H3>
            <div className="bg-muted/50 rounded-lg p-4">
              <Paragraph className="mt-0">
        ...
        <section>
          <Card className="p-6">
            <H3 className="mt-0 mb-4">Záložky</H3>
            <div className="bg-muted/50 rounded-lg p-4">
              <Paragraph className="mt-0">
        ...
        <section>
          <Card className="p-6">
            <H3 className="mt-0 mb-4">Přizpůsobení zobrazení</H3>

            <div className="grid gap-4 md:grid-cols-2">
              <div className="bg-muted/50 rounded-lg p-4">
                <h4 className="mt-0 mb-2 text-2xl font-bold">Velikost písma</h4>
                <Paragraph className="mb-0">
              ...
              <div className="bg-muted/50 rounded-lg p-4">
                <h4 className="mt-0 mb-2 text-2xl font-bold">Tmavý režim</h4>
                <Paragraph className="mb-0">
        ...
        <section>
          <Card className="p-6">
            <H3 className="mt-0 mb-4">Rychlý přístup k denním textům</H3>
            <div className="bg-muted/50 rounded-lg p-4">
              <Paragraph className="mt-0">
